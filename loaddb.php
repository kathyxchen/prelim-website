...
*/
  ...
  $createauth = "CREATE TABLE authors (ID int(11) AUTO_INCREMENT, name varchar(255), email varchar(255), PRIMARY KEY (ID))";
  //$createart = "CREATE TABLE articles (ID int(11) AUTO_INCREMENT, title varchar(255), author varchar(255), body LONGTEXT, PRIMARY KEY (ID))";
  ...
  $cmds = array($createauth, $drop, $addauth, $addtime);
  foreach ($cmds as $cmd) {
